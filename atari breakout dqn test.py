...
if __name__ == '__main__':
    ...
    epsilon = 0.0             # epsilon-greedy, factor to explore randomly
    ...
    load_path = "atari_dqn_breakout_best.pth" # path to load the model
    ...
    with torch.no_grad():
        ...
        live_now=6 # initialize lives+1 so that auto shoot will be mannally trigger
        while True:
            env.render()
